...
var createHTML = function(text, completed)  {
  ...
  if (completed) {
    var style = 'completed-task';
    var disabled = "disabled='disabled'";
  }
  else {
    var style = 'active-task'
    var disabled = "";
  }
  var prefix = "<li class=" + style + " id='task-"+count+"'><div class='list-item-text'>";
  var suffix = "</div><div class='list-item-menu'><input type='submit' value='Completed' class='completed-task-button' id='task-button-"+count+"' "+disabled+"/></div></li>";
